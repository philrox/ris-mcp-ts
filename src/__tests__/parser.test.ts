...
describe("extractText", () => {
  ...
  describe("object with item property", () => {
    ...
    it("should join array items with comma separator", () => {
      expect(extractText({ item: ["First", "Second", "Third"] })).toBe(
        "First, Second, Third"
      );
    });
  ...
  describe("priority handling", () => {
    it("should prefer #text over item when both exist", () => {
      expect(extractText({ "#text": "Text Value", item: "Item Value" })).toBe(
        "Text Value"
      );
    });

    it("should fall back to item when #text is undefined", () => {
      expect(extractText({ "#text": undefined, item: "Item Value" })).toBe(
        "Item Value"
      );
    });
  });
      ...
      const rawDoc: RawDocumentReference = {
        Data: {
          Metadaten: {
            ...
            Allgemein: {
              DokumentUrl: "https://ris.bka.gv.at/Dokument.wxe?Abfrage=Bundesnormen&Dokumentnummer=NOR40250169",
            },
            Bundesrecht: {
              Kurztitel: "ABGB",
              ...
              BrKons: {
                ...
                GesamteRechtsvorschriftUrl: "https://ris.bka.gv.at/GeltendeFassung.wxe?Abfrage=Bundesnormen&Gesetzesnummer=10001622",
              },
            },
          },
          Dokumentliste: {
      ...
      const rawDoc: RawDocumentReference = {
        Data: {
          Metadaten: {
            ...
            Allgemein: {
              DokumentUrl: "https://ris.bka.gv.at/Dokument.wxe?Abfrage=LrW&Dokumentnummer=LNO40001234",
            },
            Landesrecht: {
              ...
              LrKons: {
                ...
                GesamteRechtsvorschriftUrl: "https://ris.bka.gv.at/GeltendeFassung.wxe?Abfrage=LrW&Gesetzesnummer=20000006",
              },
            },
          },
          Dokumentliste: {
            ContentReference: {
              ...
              Urls: {
                ContentUrl: [
                  { DataType: "Html", Url: "https://ris.bka.gv.at/lr.html" },
                ],
              },
            },
          },
      ...
      const rawDoc: RawDocumentReference = {
        Data: {
          Metadaten: {
            ...
            Allgemein: {
              DokumentUrl: "https://ris.bka.gv.at/Dokument.wxe?Abfrage=Vwgh&Dokumentnummer=JWR_2024010001",
            },
            Judikatur: {
          ...
          Dokumentliste: {
            ContentReference: {
              ...
              Urls: {
                ContentUrl: [
                  { DataType: "Html", Url: "https://ris.bka.gv.at/jud.html" },
                ],
              },
            },
          },
...
describe("parseSearchResults", () => {
  ...
  describe("integration with document parsing", () => {
    it("should correctly parse complex documents in search results", () => {
            ...
            Data: {
              ...
              Dokumentliste: {
                ContentReference: {
                  Urls: {
                    ContentUrl: [
                      { DataType: "Html", Url: "https://ris.bka.gv.at/abgb.html" },
                    ],
                  },
                },
              },
      ...
      expect(result.documents[0].content_urls.html).toBe(
        "https://ris.bka.gv.at/abgb.html"
      );
